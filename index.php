...
define('__DEBUG__', $_SERVER['APIPHP']['Config']['Base']['debug']);
...
date_default_timezone_set($_SERVER['APIPHP']['Config']['Base']['timeZone']);

if ($_SERVER['APIPHP']['Config']['Base']['timeLimit'] !== false) {
    set_time_limit($_SERVER['APIPHP']['Config']['Base']['timeLimit']);
}

if ($_SERVER['APIPHP']['Config']['Base']['https']) {
...
define('__URI__', $_SERVER['APIPHP']['URI']);
...
if (file_exists(__ROOT__ . '/temp/cache' . __URI__ . '.php')) {
    ...
    echo($Content);
} elseif (!empty($_SERVER['APIPHP']['Config']['Base']['pageNotFound'])) {
    header('Location: ' . $_SERVER['APIPHP']['Config']['Base']['pageNotFound']);
} else {
